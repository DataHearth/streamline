...
// The TorrentSessionFunc type is an adapter to allow the use of ordinary
// function as TorrentSession mutator.
type TorrentSessionFunc func(context.Context, *ent.TorrentSessionMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f TorrentSessionFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.TorrentSessionMutation); ok {
		return f(ctx, mv)
	}
...
// function as TranscodeJob mutator.
type TranscodeJobFunc func(context.Context, *ent.TranscodeJobMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f TranscodeJobFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.TranscodeJobMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.TranscodeJobMutation", m)
}
