...
func (_q *MovieEventQuery) Where(ps ...predicate.MovieEvent) *MovieEventQuery {
...
func (_q *MovieEventQuery) Order(o ...movieevent.OrderOption) *MovieEventQuery {
...
func (_q *MovieEventQuery) QueryMovie() *MovieQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(movieevent.Table, movieevent.FieldID, selector),
...
// First returns the first MovieEvent entity from the query.
// Returns a *NotFoundError when no MovieEvent was found.
func (_q *MovieEventQuery) First(ctx context.Context) (*MovieEvent, error) {
	...
	if len(nodes) == 0 {
		return nil, &NotFoundError{movieevent.Label}
	}
	return nodes[0], nil
}
...
// FirstID returns the first MovieEvent ID from the query.
// Returns a *NotFoundError when no MovieEvent ID was found.
...
// Only returns a single MovieEvent entity found by the query, ensuring it only returns one.
// Returns a *NotSingularError when more than one MovieEvent entity is found.
// Returns a *NotFoundError when no MovieEvent entities are found.
func (_q *MovieEventQuery) Only(ctx context.Context) (*MovieEvent, error) {
	...
	case 0:
		return nil, &NotFoundError{movieevent.Label}
	default:
		return nil, &NotSingularError{movieevent.Label}
	}
}
...
// OnlyID is like Only, but returns the only MovieEvent ID in the query.
// Returns a *NotSingularError when more than one MovieEvent ID is found.
...
func (_q *MovieEventQuery) OnlyID(ctx context.Context) (id uint32, err error) {
	...
	case 0:
		err = &NotFoundError{movieevent.Label}
	default:
		err = &NotSingularError{movieevent.Label}
	}
	return
}
...
func (_q *MovieEventQuery) All(ctx context.Context) ([]*MovieEvent, error) {
	...
	qr := querierAll[[]*MovieEvent, *MovieEventQuery]()
	return withInterceptors[[]*MovieEvent](ctx, _q, qr, _q.inters)
}
...
func (_q *MovieEventQuery) IDs(ctx context.Context) (ids []uint32, err error) {
	...
	if err = _q.Select(movieevent.FieldID).Scan(ctx, &ids); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (_q *MovieEventQuery) Count(ctx context.Context) (int, error) {
	...
	return withInterceptors[int](ctx, _q, querierCount[*MovieEventQuery](), _q.inters)
}
...
// Clone returns a duplicate of the MovieEventQuery builder, including all associated steps. It can be
...
func (_q *MovieEventQuery) Clone() *MovieEventQuery {
	...
	return &MovieEventQuery{
		config:     _q.config,
		ctx:        _q.ctx.Clone(),
		order:      append([]movieevent.OrderOption{}, _q.order...),
		inters:     append([]Interceptor{}, _q.inters...),
		predicates: append([]predicate.MovieEvent{}, _q.predicates...),
...
func (_q *MovieEventQuery) GroupBy(field string, fields ...string) *MovieEventGroupBy {
	...
	grbuild := &MovieEventGroupBy{build: _q}
	grbuild.flds = &_q.ctx.Fields
	grbuild.label = movieevent.Label
...
func (_q *MovieEventQuery) Select(fields ...string) *MovieEventSelect {
	...
	sbuild := &MovieEventSelect{MovieEventQuery: _q}
	sbuild.label = movieevent.Label
...
func (_q *MovieEventQuery) prepareQuery(ctx context.Context) error {
...
func (_q *MovieEventQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*MovieEvent, error) {
	var (
		nodes       = []*MovieEvent{}
		withFKs     = _q.withFKs
		_spec       = _q.querySpec()
	...
	if withFKs {
		_spec.Node.Columns = append(_spec.Node.Columns, movieevent.ForeignKeys...)
	}
	_spec.ScanValues = func(columns []string) ([]any, error) {
		return (*MovieEvent).scanValues(nil, columns)
	}
	_spec.Assign = func(columns []string, values []any) error {
		node := &MovieEvent{config: _q.config}
	...
	if query := _q.withMovie; query != nil {
		if err := _q.loadMovie(ctx, query, nodes, nil,
			func(n *MovieEvent, e *Movie) { n.Edges.Movie = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *MovieEventQuery) loadMovie(ctx context.Context, query *MovieQuery, nodes []*MovieEvent, init func(*MovieEvent), assign func(*MovieEvent, *Movie)) error {
	ids := make([]uint32, 0, len(nodes))
	nodeids := make(map[uint32][]*MovieEvent)
	for i := range nodes {
...
func (_q *MovieEventQuery) sqlCount(ctx context.Context) (int, error) {
	_spec := _q.querySpec()
...
func (_q *MovieEventQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(movieevent.Table, movieevent.Columns, sqlgraph.NewFieldSpec(movieevent.FieldID, field.TypeUint32))
	_spec.From = _q.sql
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		for i := range fields {
			if fields[i] != movieevent.FieldID {
...
func (_q *MovieEventQuery) sqlQuery(ctx context.Context) *sql.Selector {
	builder := sql.Dialect(_q.driver.Dialect())
	t1 := builder.Table(movieevent.Table)
	columns := _q.ctx.Fields
	if len(columns) == 0 {
		columns = movieevent.Columns
	}
...
func (_g *MovieEventGroupBy) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*MovieEventQuery, *MovieEventGroupBy](ctx, _g.build, _g, _g.build.inters, v)
}

func (_g *MovieEventGroupBy) sqlScan(ctx context.Context, root *MovieEventQuery, v any) error {
...
func (_s *MovieEventSelect) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*MovieEventQuery, *MovieEventSelect](ctx, _s.MovieEventQuery, _s, _s.inters, v)
}

func (_s *MovieEventSelect) sqlScan(ctx context.Context, root *MovieEventQuery, v any) error {
