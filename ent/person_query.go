...
func (_q *PersonQuery) FirstID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *PersonQuery) FirstIDX(ctx context.Context) uint32 {
...
func (_q *PersonQuery) OnlyID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *PersonQuery) OnlyIDX(ctx context.Context) uint32 {
...
func (_q *PersonQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (_q *PersonQuery) IDsX(ctx context.Context) []uint32 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *PersonQuery) loadCredits(ctx context.Context, query *CreditQuery, nodes []*Person, init func(*Person), assign func(*Person, *Credit)) error {
	...
	nodeids := make(map[uint32]*Person)
	for i := range nodes {
...
func (_q *PersonQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(person.Table, person.Columns, sqlgraph.NewFieldSpec(person.FieldID, field.TypeUint32))
	_spec.From = _q.sql
...
func (_q *PersonQuery) Modify(modifiers ...func(s *sql.Selector)) *PersonSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (_s *PersonSelect) Modify(modifiers ...func(s *sql.Selector)) *PersonSelect {
