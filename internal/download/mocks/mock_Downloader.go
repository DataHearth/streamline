...
func (_e *MockDownloader_Expecter) GrabEpisode(ctx any, result any, episodeID any, wantedEpisodes any) *MockDownloader_GrabEpisode_Call {
	return &MockDownloader_GrabEpisode_Call{Call: _e.mock.On("GrabEpisode", ctx, result, episodeID, wantedEpisodes)}
}

func (_c *MockDownloader_GrabEpisode_Call) Run(run func(ctx context.Context, result indexer.SearchResult, episodeID uint32, wantedEpisodes []uint32)) *MockDownloader_GrabEpisode_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockDownloader_GrabEpisode_Call) RunAndReturn(run func(ctx context.Context, result indexer.SearchResult, episodeID uint32, wantedEpisodes []uint32) (*ent.DownloadRecord, error)) *MockDownloader_GrabEpisode_Call {
	_c.Call.Return(run)
	return _c
}
...
// PurgeRecordForHash provides a mock function for the type MockDownloader
func (_mock *MockDownloader) PurgeRecordForHash(ctx context.Context, torrentHash string) error {
	ret := _mock.Called(ctx, torrentHash)

	if len(ret) == 0 {
		panic("no return value specified for PurgeRecordForHash")
	}

	var r0 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, string) error); ok {
		r0 = returnFunc(ctx, torrentHash)
	} else {
		r0 = ret.Error(0)
	}
	return r0
...
// MockDownloader_PurgeRecordForHash_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'PurgeRecordForHash'
type MockDownloader_PurgeRecordForHash_Call struct {
	*mock.Call
}

// PurgeRecordForHash is a helper method to define mock.On call
//   - ctx context.Context
//   - torrentHash string
func (_e *MockDownloader_Expecter) PurgeRecordForHash(ctx any, torrentHash any) *MockDownloader_PurgeRecordForHash_Call {
	return &MockDownloader_PurgeRecordForHash_Call{Call: _e.mock.On("PurgeRecordForHash", ctx, torrentHash)}
}

func (_c *MockDownloader_PurgeRecordForHash_Call) Run(run func(ctx context.Context, torrentHash string)) *MockDownloader_PurgeRecordForHash_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockDownloader_PurgeRecordForHash_Call) Return(err error) *MockDownloader_PurgeRecordForHash_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *MockDownloader_PurgeRecordForHash_Call) RunAndReturn(run func(ctx context.Context, torrentHash string) error) *MockDownloader_PurgeRecordForHash_Call {
	_c.Call.Return(run)
	return _c
}
