...
func (_e *MockTx_Expecter) ListDownloadingRecords(ctx interface{}) *MockTx_ListDownloadingRecords_Call {
	return &MockTx_ListDownloadingRecords_Call{Call: _e.mock.On("ListDownloadingRecords", ctx)}
}

func (_c *MockTx_ListDownloadingRecords_Call) Run(run func(ctx context.Context)) *MockTx_ListDownloadingRecords_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context))
	})
	return _c
...
func (_c *MockTx_ListDownloadingRecords_Call) Return(_a0 []*ent.DownloadRecord, _a1 error) *MockTx_ListDownloadingRecords_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockTx_ListDownloadingRecords_Call) RunAndReturn(run func(context.Context) ([]*ent.DownloadRecord, error)) *MockTx_ListDownloadingRecords_Call {
	_c.Call.Return(run)
	return _c
}
