...
CREATE TABLE `new_torrent_sessions` (`id` integer NOT NULL PRIMARY KEY AUTOINCREMENT, `create_time` datetime NOT NULL, `update_time` datetime NOT NULL, `info_hash` text NOT NULL, `name` text NULL, `save_path` text NOT NULL, `source_magnet` text NULL, `source_torrent` blob NULL, `paused` bool NOT NULL DEFAULT (false), `completed_at` datetime NULL, `seed_stopped` bool NOT NULL DEFAULT (false), `uploaded` integer NOT NULL DEFAULT (0));
-- copy rows from old table "torrent_sessions" to new temporary table "new_torrent_sessions"
INSERT INTO `new_torrent_sessions` (`id`, `create_time`, `update_time`, `info_hash`, `name`, `save_path`, `source_magnet`, `source_torrent`, `paused`, `completed_at`, `seed_stopped`) SELECT `id`, `create_time`, `update_time`, `info_hash`, `name`, `save_path`, `source_magnet`, `source_torrent`, `paused`, `completed_at`, `seed_stopped` FROM `torrent_sessions`;
