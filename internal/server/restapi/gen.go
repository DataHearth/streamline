...
// Defines values for RequestStatusParam.
const (
	RequestStatusParamApproved  RequestStatusParam = "approved"
	RequestStatusParamAvailable RequestStatusParam = "available"
	RequestStatusParamDenied    RequestStatusParam = "denied"
	RequestStatusParamPending   RequestStatusParam = "pending"
)

// Valid indicates whether the value is a known member of the RequestStatusParam enum.
func (e RequestStatusParam) Valid() bool {
	switch e {
	case RequestStatusParamApproved:
		return true
	case RequestStatusParamAvailable:
		return true
...
type Episode struct {
	...
	// GrabFailures Consecutive failed grabs for this episode. Omitted when zero. At
	// `library.max_grab_failures` the episode stops being searched
	// entirely, so a non-zero value is the only warning an operator
	// gets before it goes quiet. Reset by any successful grab.
...
type ServerInterface interface {
	...
	// ListDownloadHistory Terminal download history (completed/failed), paginated.
	// (GET /activity/history)
	ListDownloadHistory(w http.ResponseWriter, r *http.Request, params ListDownloadHistoryParams)
	// ClearCompletedHistory Delete all completed history records.
	...
	// SearchMovie Search indexers for a movie
	...
	// CreateQualityProfile Create a quality profile
	...
	// GrabEpisodeRelease Grab a specific release for this episode
	...
	// BrowseEpisodeReleases Search indexers for one episode's releases
	...
	// GrabSeriesRelease Grab a whole-series release
	// (POST /series/{id}/grab)
	GrabSeriesRelease(w http.ResponseWriter, r *http.Request, id ResourceID)
	// GetSeriesPlayOnLinks Resolve per-server deep links for the series
	...
	// BrowseSeasonReleases Search indexers for a season's releases
	...
	// GetSystemInfo Read-only environment summary (admin)
	// (GET /system/info)
	GetSystemInfo(w http.ResponseWriter, r *http.Request)
	// ListTorrents List torrents held by the builtin download client
	// (GET /torrents)
	...
	// GetTorrent Torrent details (files, trackers, peers)
	// (GET /torrents/{hash})
	GetTorrent(w http.ResponseWriter, r *http.Request, hash TorrentHash)
	// SetTorrentFilePriority Set a torrent file's download priority
...
func (siw *ServerInterfaceWrapper) UpdateImportFileDecision(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "fileId", chi.URLParam(r, "fileId"), &fileId, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "integer", Format: "", ValueIsUnescaped: r.URL.RawPath == ""})
	if err != nil {
...
func (siw *ServerInterfaceWrapper) UpdateImportShowDecision(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "showId", chi.URLParam(r, "showId"), &showId, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "integer", Format: "", ValueIsUnescaped: r.URL.RawPath == ""})
	if err != nil {
...
func (siw *ServerInterfaceWrapper) GetTMDBMovieDetail(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "tmdb_id", chi.URLParam(r, "tmdb_id"), &tmdbId, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "integer", Format: "", ValueIsUnescaped: r.URL.RawPath == ""})
	if err != nil {
...
func (siw *ServerInterfaceWrapper) GetSeriesLookupDetail(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "tvdb_id", chi.URLParam(r, "tvdb_id"), &tvdbId, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "integer", Format: "", ValueIsUnescaped: r.URL.RawPath == ""})
	if err != nil {
...
func (siw *ServerInterfaceWrapper) PatchEpisode(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "episodeId", chi.URLParam(r, "episodeId"), &episodeId, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "integer", Format: "", ValueIsUnescaped: r.URL.RawPath == ""})
	if err != nil {
...
func (siw *ServerInterfaceWrapper) PatchSeason(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "number", chi.URLParam(r, "number"), &number, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "integer", Format: "", ValueIsUnescaped: r.URL.RawPath == ""})
	if err != nil {
...
func (siw *ServerInterfaceWrapper) DeleteUser(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "uid", chi.URLParam(r, "uid"), &uid, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "integer", Format: "", ValueIsUnescaped: r.URL.RawPath == ""})
	if err != nil {
...
func (siw *ServerInterfaceWrapper) RevokeUserApiKey(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "kid", chi.URLParam(r, "kid"), &kid, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "integer", Format: "", ValueIsUnescaped: r.URL.RawPath == ""})
	if err != nil {
...
func (siw *ServerInterfaceWrapper) RevokeUserSession(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "sid", chi.URLParam(r, "sid"), &sid, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "integer", Format: "", ValueIsUnescaped: r.URL.RawPath == ""})
	if err != nil {
